...
router = APIRouter(
    # [FIX EXPERT] Le préfixe "/api" est géré dans main.py. On ne garde que le préfixe spécifique à l'authentification.
    # Cela, combiné au renommage du fichier, résout le 404 Not Found.
    prefix="/auth",
    tags=["Authentication"]
)
