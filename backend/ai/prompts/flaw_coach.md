...
6. **NIVEAU DE RISQUE :** Évalue la criticité de ce défaut SPÉCIFIQUEMENT pour le poste visé avec cette échelle : `P1 (Critique)`, `P2 (Vigilance)`, `P3 (Mineur)`.
7. **TRI OBLIGATOIRE :** Tu DOIS impérativement classer le tableau de sortie pour afficher les défauts `P1` en premier, suivis des `P2`, et enfin les `P3`.
  ...
  "coaching": [
    {
      ...
      "impact_level": "P1 (Critique) | P2 (Vigilance) | P3 (Mineur)",
