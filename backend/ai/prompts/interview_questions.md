...
## 🎯 OBJECTIF
Structurer l'entretien de manière ultra-précise en choisissant EXACTEMENT 3 domaines clés liés au poste (ex: Management, Stratégie, Opérationnel). Pour CHAQUE domaine, générer EXACTEMENT 3 questions. La 10ème question doit être la clôture ("Avez-vous des questions ?").

## ⛔ CONTRAINTES IMPÉRATIVES
- **QUANTITÉ STRICTE :** Tu DOIS générer EXACTEMENT 10 questions au total.
- **RÉPARTITION (3x3) :** 3 domaines majeurs X 3 questions par domaine.
