...
L'angle des questions DOIT s'adapter au type d'interlocuteur ("Type d'entretien prévu" dans le contexte) :
- Si **rh** (Ressources Humaines) : Focus sur le "fit" culturel, la motivation profonde, la stabilité, le salaire, la mobilité et les "red flags" comportementaux (trous dans le CV, licenciements).
- Si **manager** (Opérationnel) : Focus sur l'impact, l'autonomie, la gestion des conflits d'équipe, les résultats concrets (méthode STAR) et la priorisation.
