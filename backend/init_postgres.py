...
def main():
    ...
    try:
        ...
        # --- TABLE DES PREUVES EXTRAITES DES RÉPONSES ---
        cur.execute("""
            CREATE TABLE IF NOT EXISTS candidate_evidence (
                id TEXT PRIMARY KEY,
                user_id TEXT REFERENCES users(id) ON DELETE CASCADE,
                source_answer_id TEXT REFERENCES training_sessions(id) ON DELETE SET NULL,
        ...
        """)
        print("✅ Table 'candidate_evidence' created")

        # --- TABLE DES SCORES DE COMPÉTENCES ÉVOLUTIFS ---
        cur.execute("""
        ...
        """)
        print("✅ Table 'candidate_competency_scores' created")
