...
## 🎯 OBJECTIF
Générer EXACTEMENT 10 questions d'entretien d'une extrême pertinence, adaptées spécifiquement à ce candidat. Parmi ces 10 questions, tu DOIS inclure au moins 5 questions de type "Mise en situation immersive" (scénarios complexes basés sur les défis du poste visé).
